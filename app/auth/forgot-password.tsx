...
export default function ForgotPasswordPage() {
    ...
    return (
        <AuthLayout subChildren={subChildren()}>
            ...
            <TouchableOpacity onPress={handleForgotPassword} className="w-full h-12 bg-blue-500 text-white text-center rounded-lg mt-4 p-2">
                <Text className="w-full h-12 bg-blue-500 text-white text-center rounded-lg mt-4 p-2">{t('AUTH.FORGOT_PASSWORD')}</Text>
            </TouchableOpacity>
        </AuthLayout>
    );
}